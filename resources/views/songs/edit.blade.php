<x-default-layout title="Edit Song" section_title="Edit Song">
    <div class="py-10">
        <div class="max-w-2xl mx-auto bg-gray-900 rounded-lg shadow-lg p-6">
            ...
            <div class="flex justify-end gap-4 mt-4">
                ...
                <button 
                    class="bg-green-400 text-gray-900 px-4 py-2 rounded-lg hover:bg-green-600 transition duration-300">
                    Update
                </button>
            </div>
        </div>
